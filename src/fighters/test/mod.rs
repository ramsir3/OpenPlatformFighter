use crate::common::animation::{Animation, AnimationState};
use crate::common::fighter::{AnimationArray, Fighter};
use crate::common::frame::{Frame, FrameData, FrameType};
